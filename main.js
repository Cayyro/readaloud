...
var FormData$1 = /*@__PURE__*/getDefaultExportFromCjs(browser);
...
var httpAdapter = isHttpAdapterSupported && function httpAdapter(config) {
  return wrapAsync(async function dispatchHttpRequest(resolve, reject, onDone) {
    ...
    if (config.transport) {
      ...
      transport = isHttpsRequest ? require$$2__default["default"] : require$$1__default["default"];
    } else {
...
class ReadAloudPlugin extends obsidian.Plugin {
    constructor() {
        super(...arguments);
    ...
    speakText(text) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!text) {
                new obsidian.Notice('Please select some text first.');
                return;
            }
            const charCount = text.length;
            const costPerMillionChars = this.settings.model === 'tts-1' ? 15.0 : 30.0;
            const cost = (charCount / 1000000) * costPerMillionChars;
            new obsidian.Notice(`Text is being sent to OpenAI for processing. Estimated cost: $${cost.toFixed(4)}`);
            try {
                const response = yield this.sendTextToOpenAI(text);
                this.playAudio(response.data);
            }
            catch (error) {
                console.error('Error:', error);
                new obsidian.Notice('Error: Unable to read aloud the selected text.');
            }
        });
    }
    sendTextToOpenAI(text) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios$1.post('https://api.openai.com/v1/audio/speech', {
    ...
    loadSettings() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                new obsidian.Notice('Failed to load settings. Please check your settings file.');
                this.settings = DEFAULT_SETTINGS;
            }
        });
    }
    saveSettings() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                new obsidian.Notice('Failed to save settings. Please try again.');
            }
        });
    }
}
class ReadAloudSettingTab extends obsidian.PluginSettingTab {
